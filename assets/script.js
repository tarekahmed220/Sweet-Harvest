...
switcherlist.forEach(function (li) { //function before addevenlistener mustbe anonymous function
  console.log(li)
...
function cart(id){
  ...
  if(username){
    ...
    product_added = {...product_added, userEmail:{...product_added.userEmail,email}}
